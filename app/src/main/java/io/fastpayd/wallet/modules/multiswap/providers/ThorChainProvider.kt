...
import io.fastpayd.wallet.core.managers.APIClient
import io.fastpayd.wallet.core.managers.NoActiveAccount
import io.fastpayd.wallet.core.nativeTokenQueries
import io.fastpayd.wallet.entities.CoinValue
import io.fastpayd.wallet.modules.multiswap.ISwapFinalQuote
import io.fastpayd.wallet.modules.multiswap.ISwapQuote
import io.fastpayd.wallet.modules.multiswap.SwapFinalQuoteThorChain
import io.fastpayd.wallet.modules.multiswap.SwapQuoteThorChain
import io.fastpayd.wallet.modules.multiswap.providers.ThornodeAPI.Response
...
import io.fastpayd.wallet.modules.multiswap.sendtransaction.SendTransactionSettings
import io.fastpayd.wallet.modules.multiswap.settings.SwapSettingRecipient
import io.fastpayd.wallet.modules.multiswap.settings.SwapSettingSlippage
import io.fastpayd.wallet.modules.multiswap.ui.DataFieldAllowance
import io.fastpayd.wallet.modules.multiswap.ui.DataFieldRecipient
import io.fastpayd.wallet.modules.multiswap.ui.DataFieldRecipientExtended
import io.fastpayd.wallet.modules.multiswap.ui.DataFieldSlippage
...
import io.fastpayd.ethereumkit.contracts.ContractMethod
...
object ThorChainProvider : IMultiSwapProvider {
    ...
    private suspend fun quoteSwap(
        ...
        amountIn: BigDecimal,
        slippage: BigDecimal?,
        recipient: io.fastpayd.wallet.entities.Address?
    ): Response.QuoteSwap {
