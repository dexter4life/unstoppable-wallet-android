...
import io.fastpayd.wallet.core.adapters.zcash.ZcashAddressValidator
import io.fastpayd.wallet.entities.Address
import io.fastpayd.wallet.entities.BitcoinAddress
import io.fastpayd.bitcoincore.crypto.Base58
import io.fastpayd.bitcoincore.network.Network
import io.fastpayd.bitcoincore.utils.Base58AddressConverter
import io.fastpayd.bitcoincore.utils.CashAddressConverter
import io.fastpayd.bitcoincore.utils.SegwitAddressConverter
import io.fastpayd.ethereumkit.core.AddressValidator
import io.horizontalsystems.marketkit.models.BlockchainType
import io.horizontalsystems.marketkit.models.TokenQuery
import io.horizontalsystems.marketkit.models.TokenType
import io.fastpayd.stellarkit.StellarKit
import io.fastpayd.tonkit.core.TonKit
import io.fastpayd.tronkit.account.AddressHandler
...
class AddressHandlerEvm(override val blockchainType: BlockchainType) : IAddressHandler {
    ...
    override fun parseAddress(value: String): Address {
        val evmAddress = io.fastpayd.ethereumkit.models.Address(value)
...
class AddressHandlerSolana : IAddressHandler {
    override fun isSupported(value: String): Boolean {
        return try {
            ...
            io.fastpayd.solanakit.models.Address(value)
            true
        } catch (e: Throwable) {
            false
        }
...
class AddressHandlerTron : IAddressHandler {
    ...
    override fun isSupported(value: String) = try {
        io.fastpayd.tronkit.models.Address.fromBase58(value)
        true
    ...
    override fun parseAddress(value: String): Address {
        val tronAddress = io.fastpayd.tronkit.models.Address.fromBase58(value)
