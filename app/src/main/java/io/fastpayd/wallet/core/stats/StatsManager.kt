package io.fastpayd.wallet.core.stats
...
import io.fastpayd.wallet.core.storage.StatsDao
...
import io.fastpayd.wallet.modules.coin.CoinModule
...
import io.fastpayd.wallet.modules.market.etf.EtfModule
...
import io.fastpayd.wallet.modules.market.search.MarketSearchSection
...
val MainModule.MainNavigation.statTab: StatTab
    get() = when (this) {
        MainModule.MainNavigation.Home -> StatTab.Markets
